...
/**
 * Transitive closure on a graph. 图的传递闭包
 *
...
object SparkTC {
  ...
  def generateGraphFromStr = {
    val lines = scala.io.Source.fromFile("src/main/resources/TC.txt").getLines().toList
  ...
  def main(args: Array[String]) {
    ...
    var tc = spark.parallelize(generateGraphFromStr, slices).cache()
