...
/**
 * Usage: java cn.fraudmetrix.vulcan.rainbowtable.sstable.BulkLoadExample
 */
public class BulkLoadExample
{
    public static final String CSV_URL = "http://real-chart.finance.yahoo.com/table.csv?s=%s"+"&a=8&b=15&c=2015";

    /** Default output directory */
    public static final String DEFAULT_OUTPUT_DIR = "./data_20150924";
    ...
    public static void main(String[] args)
    {
        if (args.length == 0)
        {
            System.out.println("usage: java cn.fraudmetrix.vulcan.rainbowtable.sstable.BulkLoadExample <list of ticker symbols>");
            return;
        }
