package com.xiaomi.storm.kafka;
...
public class KafkaUtil {
    ...
    public static long getOffsetBefore(SimpleConsumer consumer, String topic, int partition, long whichTime){
        ...
        OffsetRequest request = new OffsetRequest(requestInfo,kafka.api.OffsetRequest.CurrentVersion(), clientName(topic, partition));
        // 获取指定时间前有效的offset列表
    ...
    public static String clientName(String topic, int partition){
