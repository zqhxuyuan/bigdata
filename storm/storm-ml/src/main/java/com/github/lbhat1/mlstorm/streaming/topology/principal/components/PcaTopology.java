package com.github.lbhat1.mlstorm.streaming.topology.principal.components;
...
import com.github.lbhat1.mlstorm.streaming.bolt.ml.state.pca.create.WindowedPcaFactory;
import com.github.lbhat1.mlstorm.streaming.bolt.ml.state.pca.query.PrincipalComponentsAggregator;
import com.github.lbhat1.mlstorm.streaming.bolt.ml.state.pca.query.PrincipalComponentsQuery;
import com.github.lbhat1.mlstorm.streaming.bolt.ml.state.pca.update.PrincipalComponentUpdater;
...
import com.github.lbhat1.mlstorm.streaming.spout.ml.sensor.SensorStreamingSpout;
...
public class PcaTopology {
    ...
    // Look at SensorStreamingSpout or AustralianElectricityPricingSpout for example.
