...
public class PlayAUDurationCalculator extends GenericIndicatorCalculator<StatResult, Jedis, JSONObject> {
	
	private static final long serialVersionUID = 1L;
	private static final Log LOG = LogFactory.getLog(PlayAUDurationCalculator.class);

	public PlayAUDurationCalculator() {
		super(StatIndicators.PLAY_AU_DURATION);
	}
