...
public class Flow implements Serializable{
    ...
    //获得某个Stream的FlowOp的数量
    public int getStreamFlowOpsSize(String streamName){
        return streams.get(streamName).getFlowOps().size();
    }

    //获得Stream中某个index位置的FlowOp
    public FlowOp getFlowOp(String streamName, int index){
        return streams.get(streamName).getFlowOps().get(index);
    }
