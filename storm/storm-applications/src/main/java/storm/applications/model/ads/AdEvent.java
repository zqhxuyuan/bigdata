...
public class AdEvent implements Serializable {
    ...
    private Type type;          //类型: 点击,有效果
    private String displayUrl;  //显示的URL
    private long queryId;       //查询编号
    private long adID;          //广告
    private long userId;        //用户
    private long advertiserId;  //广告主
    private long keywordId;     //关键词
    private long titleId;       //题目
    private long descriptionId; //描述
