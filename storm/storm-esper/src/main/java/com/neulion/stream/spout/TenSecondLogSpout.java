...
public class TenSecondLogSpout extends BaseRichSpout {
    ...
    //测试的数据文件路径.
    private static String path = System.getProperty("user.dir") + "/storm-esper/data/";
    private static String LOG_FILENAME = TenSecondLogSpout.class.getClass().getResource("/").getPath() + "/10secondsimulator.log";
